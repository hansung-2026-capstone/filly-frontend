  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--notebook-bg)] relative overflow-hidden">
      ...
      <div 
        ...
        style={{
          background: 'radial-gradient(circle at 30% 40%, rgba(92,74,58,0.8) 0%, rgba(92,74,58,0.4) 50%, transparent 100%)'
        }}
      />
      ...
      <div 
        ...
        style={{
          background: 'repeating-linear-gradient(92deg, transparent, transparent 18px, rgba(0,0,0,0.03) 18px, rgba(0,0,0,0.03) 19px)'
        }}
      />
      ...
      <div className="relative z-[2]">
        ...
        <div 
          ...
          style={{
            boxShadow: '0 40px 80px rgba(0,0,0,0.45), 0 15px 35px rgba(0,0,0,0.3)'
          }}
        />
        ...
        <div className="relative flex w-[880px] h-[600px] z-[2]">
          ...
          <div className="w-[440px] h-[600px] relative overflow-hidden">
            <div 
              ...
              style={{
                background: 'linear-gradient(135deg, #f5f0e6 0%, #faf6ed 40%, #f2ecdf 100%)',
                boxShadow: 'inset -6px 0 14px -6px rgba(0,0,0,0.03), inset 0 0 60px rgba(0,0,0,0.03)'
              }}
            >
          ...
          <div className="w-[440px] h-[600px] relative overflow-hidden">
            <div 
              ...
              style={{
                background: 'linear-gradient(225deg, #f5f0e6 0%, #faf6ed 40%, #f2ecdf 100%)',
                boxShadow: 'inset 6px 0 14px -6px rgba(0,0,0,0.03), inset 0 0 60px rgba(0,0,0,0.03)'
              }}
            >
              {/* Gradient edge effect */}
          ...
          <div 
            ...
            style={{
              background: 'linear-gradient(to right, rgba(0,0,0,0.02) 0%, rgba(0,0,0,0.05) 25%, rgba(0,0,0,0.07) 45%, rgba(0,0,0,0.07) 55%, rgba(0,0,0,0.05) 75%, rgba(0,0,0,0.02) 100%)'
            }}
          >
            <div 
              className="absolute left-1/2 top-[30px] bottom-[30px] w-0.5 -translate-x-1/2"
              style={{
                background: 'repeating-linear-gradient(to bottom, transparent, transparent 16px, rgba(120,100,80,0.08) 16px, rgba(120,100,80,0.08) 24px)'
              }}
            />
          </div>
          ...
          <div 
            ...
            style={{
              background: 'repeating-linear-gradient(to right, #ede8dc, #ede8dc 1px, #e5dfd2 1px, #e5dfd2 2px)',
          ...
          <div className="absolute right-[-44px] top-10 flex flex-col gap-1.5 z-20">
            <button
              ...
              data-page="home"
              className={`w-11 h-[52px] border-none rounded-r-md cursor-pointer flex items-center justify-center
                font-['Nanum_Pen_Script'] text-sm tracking-wider relative transition-all duration-[0.25s]
                shadow-[2px_2px_6px_rgba(0,0,0,0.15)] py-1 px-0.5 pr-0
