...
export function ArchivePage() {
  const { archives, selectedArchiveId, setSelectedArchiveId, diaries } =
    useArchive();
    ...
    <div className="flex w-full h-full font-['Nanum_Myeongjo']">
        ...
        <div className="grid grid-cols-3 gap-2.5 flex-1 content-start">
          ...
          {archives.map((archive, index) => (
            ...
            >
              ...
              <div className="text-[10px] text-[rgba(0,0,0,0.28)] tracking-wide">
      ...
      {showModal &&
        createPortal(
          ...
          >
            <div
              className="relative z-[10000] bg-[#fffdf7] rounded-lg p-6 shadow-xl"
              onClick={(e) => e.stopPropagation()}
            >
